...
public class PetRepository implements IRepository<Pet> {
    ...
    public List<Pet> getAll() {
        ...
        try {
            ...
            try (Connection dbConnection = getConnection()) {
                ...
                SQLstr = "SELECT GenusId, Id, Name, Birthday FROM pet_list ORDER BY Id";
    ...
    public Pet getById(int petId) {
        ...
        try {
            ...
            try (Connection dbConnection = getConnection()) {
                ...
                SQLstr = "SELECT GenusId, Id, Name, Birthday FROM pet_list WHERE Id = ?";
    ...
    public int create(Pet pet) {
        ...
        try {
            ...
            try (Connection dbConnection = getConnection()) {
                ...
                SQLstr = "INSERT INTO pet_list (Name, Birthday, GenusId) SELECT ?, ?, (SELECT Id FROM pet_types WHERE Genus_name = ?)";
                PreparedStatement prepSt = dbConnection.prepareStatement(SQLstr);
    ...
    public static Connection getConnection() throws SQLException, IOException {
        ...
        try (FileInputStream fis = new FileInputStream("App/Resources/database.properties")) {
